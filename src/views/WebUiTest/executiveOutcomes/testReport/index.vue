<template>
  <div style="height: 850px; position: relative" ref="test" v-loading="loading">
    <div
      style="height: 4%;margin-left: 20px; margin-bottom: 10px; margin-top: 10px;text-align:center;"
    >
      <el-button
    ...
    <div style="float:left;width: 50%;">
      <el-card class="box-card" style="margin-left: 10px;height: 320px;">
        <div style="width: 50%;float: left">
          <el-descriptions :column="1" border>
            ...
            <el-descriptions-item :contentStyle="{ 'text-align': 'center' }" label="用例数量">
              <template>
                <el-tag size="mini">
                  {{
                  "总共:" + (detailsData.use_case_error + detailsData.use_case_success)
                  }}
                </el-tag>
            ...
            <el-descriptions-item
              :contentStyle="{ 'text-align': 'center' }"
              label="通过率"
            >{{((detailsData.use_case_success) / (detailsData.use_case_error + detailsData.use_case_success)).toFixed(4)*100 + '%'}}</el-descriptions-item>
          </el-descriptions>
        </div>
      ...
      <el-card class="box-card" style="margin-left: 10px;  height: 500px;overflow-y:auto">
    ...
    <div style="float:left;width: 50%;">
      <el-card class="box-card" style="margin-left:10px;height:820px;overflow-y:auto">
        <div slot="header" class="clearfix">
          <span>步骤内容</span>
        </div>
        <div>
          <el-row>
            ...
            <el-col v-for="(step,index) in stepData" :key="index">
              <el-card style="width:29%;float:left" :body-style="{ padding: '0px', width:'100%' }">
    ...
    <!-- 调试界面 -->
    <el-drawer title="调试结果" :visible.sync="debuggingDrawer" size="90%"></el-drawer>
  </div>
</template>
